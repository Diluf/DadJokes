package com.debugsire.dadjokes.ui.Downloads;
...
import com.debugsire.dadjokes.Adapters.DownloadsAdapter;
...
public class DownloadsFragment extends Fragment {
    ...
    ItemTouchHelper.SimpleCallback simpleCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
        ...
        public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
            ...
            snackbar.addCallback(new BaseTransientBottomBar.BaseCallback<Snackbar>() {
                ...
                public void onDismissed(Snackbar transientBottomBar, int event) {
                    ...
                    Log.d(TAG, "onDismissed: " + event + " " + deletedModel.getKey());
                    if (event != 1) {
                        Realm.getDefaultInstance().executeTransactionAsync(new Realm.Transaction() {
                            @Override
                            public void execute(Realm realm) {
                                MyDownloads first = Realm.getDefaultInstance().where(MyDownloads.class)
                            ...
                            public void onSuccess() {
                                EventBus.getDefault().post(deletedModel);
                            }
                        });
                    }
                }
        ...
        public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
            ...
            new RecyclerViewSwipeDecorator.Builder(c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
                    ...
                    .addSwipeLeftLabel("Remove from downloads")
    ...
    private void initRv() {
        ...
        adapter = new DownloadsAdapter(models, getLayoutInflater());
    ...
    public void loadRv() {
        models.clear();
        for (MyDownloads myDownloads :
                Realm.getDefaultInstance().where(MyDownloads.class)
                        .findAll()) {
            models.add(new DownloadsModel(myDownloads.getKey(),
                    myDownloads.getJoke()));
        }
